...
def user_worker(worker_id):
    ...
    print(f"  Worker {worker_id:>2} done.")
...
def plot(data, output_path):
    ...
    ax.set_title(f"Request Latency — {TOTAL_REQUESTS} Requests, {NUM_WORKERS} Concurrent Workers (S3)", fontsize=14, fontweight="bold")
